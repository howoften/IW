...
public extension IWView where View: WKWebView {
    ...
    public final func load(local fileName: String, _ type: String = "html") -> Void {
    ...
    public final func removeChild(byIdentity: String, completionHandler: ((Any?, Error?) -> Void)? = nil) -> Void {
    ...
    ///   - byClass: class name
    ///   - index: Index
    public final func removeChild(bySelector selectorName: String, index: Int = -1, completionHandler: ((Any?, Error?) -> Void)? = nil) -> Void {
        var script = ""
        if index == -1 {
	...
	public final func innerHTMLContent(handler: ((_ HTMLContent: String) -> Void)?) -> Void {
	...
	public final func outerHTMLContent(handler: ((_ HTMLContent: String) -> Void)? ) -> Void {
	...
	public final func setAttrToLabel(byTagName tagName: String, attrName: String, attrValue: String) -> Void {
	...
	public final var wkContentView: UIView? {
	...
	public final func post(path: String, JSONParameters: String) {
	...
	public final func setStyle(byClassName className: String, index: Int = -1, value: String?) {
		var postJavascript = ""
		if index == -1 {
	...
	public final func setStyle(byId id: String, value: String?) {
